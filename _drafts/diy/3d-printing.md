...
I've never used one before and the only experience I have 3D modelling was a couple days in Grade 9 tech class using `AutoCAD` to design a rudimentary airplane to later make using wood. I'm excited for all the possibilities having a 3D printer will unlock. There are several 3D printers at the Microsoft Garage in Redmond that I could also be making use of... then again, most of my inspiration comes at unopportune times.

View more about printing philosophy at the botom if your heart desires.

## Prints

Here are all the things I have printed so far in reverse chronological order.
(similar to how the drawings post is used) along with their associated [`.stl` files](https://github.com/mic-max/micmax.pw/tree/master/assets/cad/), only some of which I personally designed.
...
- Hot glue doesn't hold too well...
...
<https://www.thingiverse.com/thing:16129>
